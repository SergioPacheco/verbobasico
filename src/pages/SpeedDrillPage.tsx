...
export function SpeedDrillPage({ onBack }: SpeedDrillPageProps) {
    ...
    return (
      <div className="min-h-screen flex items-center justify-center px-4">
        <div className="card max-w-sm w-full text-center animate-slide-up">
          ...
          <button onClick={startGame} className="btn-primary w-full text-lg py-4 mb-3">
            ▶️ Começar
          </button>
  ...
  return (
    <div className="min-h-screen px-4 py-6 max-w-lg mx-auto">
      ...
      <div className="flex items-center gap-3 mb-4">
        ...
        <h1 className="font-bold text-gray-900 flex-1">⚡ Speed Drill</h1>
