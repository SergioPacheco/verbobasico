  ...
  return (
    <div className="min-h-screen px-4 py-6 max-w-lg mx-auto">
      ...
      <div className="card mb-4 animate-fade-in">
        <h2 className="text-xl font-bold text-gray-900 mb-2">📚 Vocabulário</h2>
        <p className="text-gray-500 text-sm">
          Palavras e expressões que fazem a diferença no dia a dia na Espanha.
        </p>
      </div>
      ...
      {tab === 'andaluz' && (
        <div className="animate-fade-in">
          <p className="text-sm text-gray-600 mb-4 bg-yellow-50 rounded-xl p-3 border border-yellow-100">
            ...
            vai ouvir estas palavras e pronúncias todos os dias. O espanhol "standard" não te prepara pra isso!
          </p>
